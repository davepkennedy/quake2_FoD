...
qboolean R_SetMode (void)
{
	...
	if ( ( err = GLimp_SetMode( (GLint*)&vid.width, (GLint*)&vid.height, gl_mode->value, fullscreen ) ) == rserr_ok )
	{
	...
	else
	{
		if ( err == rserr_invalid_fullscreen )
		{
			...
			if ( ( err = GLimp_SetMode( (GLint*)&vid.width, (GLint*)&vid.height, gl_mode->value, false ) ) == rserr_ok )
				return true;
		}
		...
		if ( ( err = GLimp_SetMode( (GLint*)&vid.width, (GLint*)&vid.height, gl_state.prev_mode, false ) ) != rserr_ok )
		{
